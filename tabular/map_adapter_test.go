...
// TestMapAdapterReader covers normalization rules and error guards on the
// MapAdapter.Reader entry point.
func TestMapAdapterReader(t *testing.T) {
	t.Run("AcceptsSliceOfMaps", func(t *testing.T) {
	...
	t.Run("NormalizesGenericSlice", func(t *testing.T) {
		schema := newMapUserSchema(t)
		adapter := NewMapAdapter(schema)
	...
	t.Run("RejectsNonSlice", func(t *testing.T) {
		schema := newMapUserSchema(t)
		adapter := NewMapAdapter(schema)
...
// TestMapAdapterWriter covers commit-side behavior including required-field
// enforcement, cell validators and row validators.
func TestMapAdapterWriter(t *testing.T) {
	t.Run("CommitAppendsRow", func(t *testing.T) {
		schema := newMapUserSchema(t)
		adapter := NewMapAdapter(schema)
	...
	t.Run("RequiredEmptyString", func(t *testing.T) {
		schema := newMapUserSchema(t)
		adapter := NewMapAdapter(schema)
		columns := schema.Columns()
	...
	t.Run("RequiredNilValue", func(t *testing.T) {
		schema := newMapUserSchema(t)
		adapter := NewMapAdapter(schema)
		columns := schema.Columns()
	...
	t.Run("CellValidatorRejects", func(t *testing.T) {
	...
	t.Run("RowValidatorPasses", func(t *testing.T) {
		schema := newMapUserSchema(t)
	...
	t.Run("ViewGetReturnsNilForMissingKey", func(t *testing.T) {
		schema := newMapUserSchema(t)
		adapter := NewMapAdapter(schema)
