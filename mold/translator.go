...
// DictionaryResolver defines the dictionary resolver interface for converting codes to readable names.
...
// DictionaryLoader defines the contract for loading dictionary entries by key.
